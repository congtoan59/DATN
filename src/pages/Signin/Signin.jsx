                            ...
                            >
                                ...
                                <div className="relative w-[100%] mb-4 mt-6 text-center ">
                                    <input
                                        // autoComplete='off'
                                        id="email"
                                        className=" bg-transparent border-b-2 border-gray-500 text-base pb-[2px] pt-4 w-[100%] focus:border-black focus:outline-none placeholder-transparent peer "
                                        type="email"
                                        name="email"
                                        placeholder=" "
                                        value={email}
                                ...
                                <div className="relative w-[100%] mb-4  text-center">
                                    <input
                                        id="password"
                                        className="bg-transparent border-b-2 border-gray-500 text-base pb-[2px] pt-4 w-full focus:border-black focus:outline-none placeholder-transparent peer"
                                        type={
                                ...
                                <div className="flex w-[100%] mb-8 justify-between text-xs ">
                                    ...
                                    <Link className="text-xs hover:text-[#420500]">
                                        Forgot Password?
                                    </Link>
                                </div>
                                {/* login */}
